 ...
 */
final class Version20190120154311 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD slug VARCHAR(128) NOT NULL, CHANGE phone phone VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP slug, CHANGE phone phone INT DEFAULT NULL');
    }
}
